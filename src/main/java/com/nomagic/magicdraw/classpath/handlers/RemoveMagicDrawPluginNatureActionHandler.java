 ...
 */
public class RemoveMagicDrawPluginNatureActionHandler extends AbstractHandler implements IElementUpdater {
		...
		try {
			...
			for (IProject mdkProject : mdkProjects) {
				...
				case WORKSPACE_PLUGIN:
					MagicDrawPluginProjectNatureHelper.removeNature(mdkProject);
					break;
				default:
					break;
				}
			...
			throw new ExecutionException("RemoveMDKPluginNatureActionHandler", e);
		}
	}
