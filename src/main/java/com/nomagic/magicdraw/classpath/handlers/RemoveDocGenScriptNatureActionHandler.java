 ...
 */
public class RemoveDocGenScriptNatureActionHandler extends AbstractHandler implements IElementUpdater {
		...
		try {
			...
			for (IProject project : projects) {
				...
				case WORKSPACE_DOCGEN_SCRIPT:
					DocGenScriptProjectNatureHelper.removeNature(project);
					break;
				default:
					break;
				}
			...
			throw new ExecutionException("RemoveDocGenScriptNatureActionHandler", e);
		}
	}
