...
import com.nomagic.magicdraw.classpath.MDKScriptProjectNatureHelper;
 ...
 */
public class MoveToMDInstallationMDKScriptsFolderHandler extends AbstractHandler implements IElementUpdater {
	...
	public static void moveMDKScriptProjects(ISelection selection) throws CoreException {
		...
		MDKScriptProjectNatureHelper.moveMDKScriptsProjects(mdkProjectsToMove);
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			moveMDKScriptProjects(selection);
			return null;
		} catch (CoreException e) {
			throw new ExecutionException("MoveToMDInstallationScriptsFolderHandler", e);
		}
	}
