 ...
 */
public class MoveToMDInstallationDocGenScriptsFolderHandler extends AbstractHandler implements IElementUpdater {
	...
	public static void moveDocGenScriptProjects(ISelection selection) throws CoreException {
		...
		DocGenScriptProjectNatureHelper.moveMDKDocGenScriptsProjects(mdkProjectsToMove);
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			moveDocGenScriptProjects(selection);
			return null;
