 ...
 */
public class AddMDKScriptNatureActionHandler extends AbstractHandler implements IElementUpdater {
		...
		try {
			...
			for (IProject eclipseProject : eclipseProjects) {
				...
				case ECLIPSE_PROJECT:
					MDKScriptProjectNatureHelper.addNature(eclipseProject);
					break;
				default:
					break;
				}
			...
			throw new ExecutionException("AddMDKScriptNatureActionHandler", e);
		}
	}
