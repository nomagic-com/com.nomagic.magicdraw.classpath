 ...
 */
public class RemoveMDKScriptNatureActionHandler extends AbstractHandler implements IElementUpdater {
		...
		try {
			...
			for (IProject mdkProject : mdkProjects) {
				...
				case WORKSPACE_MDK_SCRIPT:
					MDKScriptProjectNatureHelper.removeNature(mdkProject);
					break;
				default:
					break;
				}
			...
			throw new ExecutionException("RemoveMDKScriptNatureActionHandler", e);
		}
	}
