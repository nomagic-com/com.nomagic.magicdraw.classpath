 ...
 */
public class AddMagicDrawPluginNatureActionHandler extends AbstractHandler implements IElementUpdater {
		...
		try {
			...
			for (IProject eclipseProject : eclipseProjects) {
				...
				case ECLIPSE_PROJECT:
					MagicDrawPluginProjectNatureHelper.addNature(eclipseProject);
					break;
				default:
					break;
				}
			...
			throw new ExecutionException("AddMDKPluginNatureActionHandler", e);
		}
	}
